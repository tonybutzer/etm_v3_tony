...
# run the mosaic
python3 conus_api_etm.py  -y 1984 --in /caldera/projects/usgs/water/impd/skagone/1_MONTHLY_ONLY/etasw --out /caldera/projects/usgs/water/impd/skagone/2_MONTHLY_MOSAICS/1984 etasw
